...
<body class="bg-neutral-900 text-white">
    ...
    <main>
        ...
        <?php if (!empty($pageData['section1_title'])): ?>
            <section class="relative bg-cover bg-center p-10 flex items-center justify-center gap-10 min-h-screen" style="background-image: url('img/hero.png');">
                ...
                <?php if (!empty($pageData['section1_image'])): ?>
                    <div class="md:w-1/2 p-4">
                        <img src="<?= htmlspecialchars($pageData['section1_image']); ?>" alt="Image utilisateur" class="w-full h-auto rounded-lg shadow-lg">
                    </div>
                <?php endif; ?>
            </section>
        <?php endif; ?>
        ...
        <?php if (!empty($pageData['section2_title'])): ?>
            <section class="relative bg-cover bg-center p-10 flex items-center justify-center gap-10 min-h-screen" style="background-image: url('img/hero.png');">
                ...
                <?php if (!empty($pageData['section2_image'])): ?>
                    <div class="md:w-1/2 p-4">
                        <img src="<?= htmlspecialchars($pageData['section2_image']); ?>" alt="Image utilisateur" class="w-full h-auto rounded-lg shadow-lg">
                    </div>
                <?php endif; ?>
            </section>
        <?php endif; ?>
